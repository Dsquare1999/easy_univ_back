...
class ReleveController extends Controller
{
    ...
    public function generate($id){
        try {
            ...
            $releves = Releve::with(['matiere', 'student.user'])->where('matiere', $id)->get();
            foreach ($releves as $releve) {
                ...
                array_push($notes, [
                    ...
                    'exam1' => $releve->exam1,
                    'observation_exam1' => $releve->observation_exam1,
                    'exam2' => $releve->exam2,
                    'observation_exam2' => $releve->observation_exam2,
                    'partial' => $releve->partial,
                    'observation_partial' => $releve->observation_partial,
                    'remedial' => $releve->remedial,
                    'observation_remedial' => $releve->observation_remedial,
                ]);
            }
            ...
            $pdfresponse = $relevesNotesController($cycle, $filiere, $classe, $matiere, $notes); 
